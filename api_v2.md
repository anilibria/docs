...
sort_direction | int | Направление сортировки. 0 - По возростанию, 1 - По убыванию | 0
...
В качестве значения так-же можно указать `*` что будет соответствовать любому значению указанного поля.
...
player **object** – Объект содержащий все плейлист аналогичный /getTitle
...
# ToDo
- [ ] Добавить поддержку авторизации (скорее всего будет с релизом нового сайта)
- [ ] Добавить доступ к API по ключу без необходимости использовать логин и пароль, и хранить куки (скорее всего будет с релизом нового сайта)